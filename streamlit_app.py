...
# Texto a traducir
text = st.text_input("Ingrese el texto a traducir:", value="Hello, world!")

# Selección de idioma de destino
target_lang = st.selectbox("Seleccione el idioma de destino:", ["DE", "ES"])
...
if st.button("Traducir"):
    if auth_key:
        ...
        st.error("Por favor, ingrese una clave de autenticación de DeepL válida.")
